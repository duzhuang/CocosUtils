import viewCell from "./ScrollViewCell";
...
export default class ScrollViewPlus extends cc.ScrollView {
    ...
    private _setContentSize() {
        ...
        console.log("tableView 这是content的高度", contentSize);
    }
    ...
    private _setContentPosition() {
        ...
        console.log("tableView 这是content的位置", this.content.y);
    }
